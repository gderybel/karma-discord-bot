...
/karma help -> show this menu
/karma play [sound] -> play the given sound
/karma list [page:optional]-> list available sounds
/karma leave -> Karma leaves the voice channel
""")
